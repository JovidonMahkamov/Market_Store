...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  final _descriptionController = TextEditingController(
    text: "Do’konga qisqa tavsif kiriting...",
  );
  final _addressController = TextEditingController(
    text: "Do’kon manzilini kiriting...",
  );
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 18.h),
                        FieldLabel(text: "Do’kon tavsifi"),
                        SizedBox(height: 8.h),
                        DescriptionWidget(
                        ...
                        SizedBox(height: 18.h),
                        FieldLabel(text: "Do’kon kategoriyasi"),
                        SizedBox(height: 8.h),
                        AppDropdownField(
                          value: _selectedCategory,
                          items: _categories,
                          hint: "Do'kon kategoriyasini tanlang",
                          onChanged: (value) {
                            setState(() {
                        ...
                        SizedBox(height: 18.h),
                        FieldLabel(text: 'Do’kon manzili'),
                        SizedBox(height: 8.h),
                        EditTextFieldWidget(
